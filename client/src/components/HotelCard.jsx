...
import { Link } from 'react-router-dom' // Link ka use hota hai dusre page pe jaane ke liye bina page reload ke
import { assets } from '../assets/assets' // images aur icons import kiye hai
// HotelCard ek component hai jo room aur index props leta hai
const HotelCard = ({room,index}) => {
  return (
    // Link component se card ko click karne par room details page pe le ja rahe hain
